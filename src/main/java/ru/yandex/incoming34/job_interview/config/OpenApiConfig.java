package ru.yandex.incoming34.job_interview.config;
...
public class OpenApiConfig {
    ...
    @Bean
    Info info() {
        return new Info().title("Тестовое задание для Backend-разработчиков. Автор: Айдинов Сергей").description("Test project")
